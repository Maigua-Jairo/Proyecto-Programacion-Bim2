...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        BtnAgregar->setGeometry(QRect(30, 230, 71, 21));
        BtnSalir = new QPushButton(centralwidget);
        BtnSalir->setObjectName("BtnSalir");
        BtnSalir->setGeometry(QRect(370, 230, 71, 21));
